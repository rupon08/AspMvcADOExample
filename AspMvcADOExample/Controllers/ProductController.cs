...
using AspMvcADOExample.DAL;
using AspMvcADOExample.Models;

namespace AspMvcADOExample.Controllers
{
        ...
        public ActionResult Create(Product product)
        {
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    if (IsInserted)
                    {
                        TempData["SuccessMessage"] = "Product deatils saved successfully....!";
                    }
                    else
                    {
        ...
        public ActionResult UpdateProduct(Product product)
        {
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    if (IsUpdated)
                    {
                        TempData["SuccessMessage"] = "Product deatils updated successfully....!";
                    }
                    else
                    {
